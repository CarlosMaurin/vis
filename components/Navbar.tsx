...
const Navbar: React.FC = () => {
  ...
  // El patrón anterior (overflow: hidden) NO funciona correctamente en iOS Safari:
  // al abrir el menu resetea la posición del scroll, y al cerrar hay un salto.
  // El patrón correcto es fijar el body con position:fixed guardando el scrollY.
  ...
  const restoreScroll = () => {
    // Restaurar estilos y reponer posición exacta
