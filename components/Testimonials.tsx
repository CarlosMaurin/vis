...
const Testimonials: React.FC = () => {
  ...
  const testimonials: TestimonialItem[] = [
    ...
    },
    {
      ...
      company: 'Hyden Place',
      quote:
        "We've been using VIS for cleaning services at our apartment complex for over a year now and couldn't be happier with the results. Their team is consistently professional, courteous, and thorough in everything they do.",
      description:
        "From common areas to unit turns, VIS always leaves the property looking spotless. What really sets them apart is their friendly attitude — they're a pleasure to work with and always go above and beyond. Highly recommend VIS to any property manager looking for a reliable, top-quality service.",
      avatar: '',
      logo: 'https://res.cloudinary.com/deit2ncmp/image/upload/q_auto/f_auto/v1774987697/hyden_place_kzxejm.png',
      logoAlt: 'Hyden Place logo',
    },
  ];
  ...
  // ── Desktop scroll transforms (desktop only, but hooks must stay at top-level) ─────────────
  // NOTA: useScroll/useSpring no pueden ser condicionados (reglas de hooks).
  // En mobile, estos motion values existen pero el div desktop está oculto con `hidden md:flex`,
  // así que no causan layout issues. El `useSpring` sí agrega listeners de scroll en mobile,
  // pero el impacto es mínimo comparado con los otros fixes. Para optimización futura
  // se puede refactorizar en un componente separado que solo se monta en desktop.
